---
app: applock
display_name: AppLock
platforms: [tiktok, instagram]
brand_dir: assets/applock/brand/
cta_dir: assets/applock/cta/
default_music_mood: ""        # e.g. "upbeat", "lofi calm", "cinematic"
posting_cadence: ""           # e.g. "3x/week"
status: active
---

# AppLock — App Manifest

> **Single source of truth for AppLock. Read this FIRST before any work on this app.**
...
- Primary: `assets/applock/cta/<file>.mp4`  — when to use: …

## Relevant screen recordings
Reusable app screen recordings live in `assets/_shared/screen-recordings/applock/`,
