---
app: trimbox
display_name: Trimbox
platforms: [tiktok, instagram]
brand_dir: assets/trimbox/brand/
cta_dir: assets/trimbox/cta/
default_music_mood: ""        # e.g. "upbeat", "lofi calm", "cinematic"
posting_cadence: ""           # e.g. "3x/week"
status: active
---

# Trimbox — App Manifest

> **Single source of truth for Trimbox. Read this FIRST before any work on this app.**
...
- Primary: `assets/trimbox/cta/<file>.mp4`  — when to use: …

## Relevant screen recordings
Reusable app screen recordings live in `assets/_shared/screen-recordings/trimbox/`,
