...
brand_dir: assets/gallery/brand/
cta_dir: assets/gallery/cta/
default_music_mood: ""        # e.g. "upbeat", "lofi calm", "cinematic"
posting_cadence: ""           # e.g. "3x/week"
status: active
---

# Gallery — App Manifest

> **Single source of truth for Gallery. Read this FIRST before any work on this app.**
...
- Primary: `assets/gallery/cta/<file>.mp4`  — when to use: …

## Relevant screen recordings
Reusable app screen recordings live in `assets/_shared/screen-recordings/gallery/`,
