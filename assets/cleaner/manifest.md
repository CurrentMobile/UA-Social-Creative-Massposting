...
brand_dir: assets/cleaner/brand/
cta_dir: assets/cleaner/cta/
default_music_mood: ""        # e.g. "upbeat", "lofi calm", "cinematic"
posting_cadence: ""           # e.g. "3x/week"
status: active
---

# Cleaner — App Manifest

> **Single source of truth for Cleaner. Read this FIRST before any work on this app.**
...
- Primary: `assets/cleaner/cta/<file>.mp4`  — when to use: …

## Relevant screen recordings
Reusable app screen recordings live in `assets/_shared/screen-recordings/cleaner/`,
