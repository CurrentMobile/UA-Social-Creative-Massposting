# Learnings — static-ad (append-only)

The ONLY file under `formats/static-ad/` agents may write. Append dated entries when a
...
_(no entries yet — first real set will seed this)_
